...
open class Item: NSObject {
     ...
     */
    public func removeFromSection(animation: ListReloadAnimation? = ListReloadAnimation.leftSlide.concatenate(with: ListReloadAnimation.scaleY).concatenate(with: ListReloadAnimation.fade)) {
